...
const additions=[
 {id:'mstaml',name:'مستعمل',url:'https://www.mstaml.com/',status:'trial-only',evidence:'Saudi individual-ad trial adapter; exact product ID, vehicle category and explicit sale evidence required. Not production-enabled.'},
