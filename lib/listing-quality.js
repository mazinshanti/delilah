...
const STRONG_NON_VEHICLE = /(?:قطع\s*(?:ال)?غيار|اكسسوار(?:ات)?|إكسسوار(?:ات)?|تشليح|للتشليح|مسجل|ستيريو|بودي\s*كت|شاش[هة]\s*(?:سيار|اندرويد|أندرويد|وكال)|spare\s*parts?|accessor(?:y|ies)|stereo|head\s*unit|body\s*kit)/i;
