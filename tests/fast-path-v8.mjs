...
if(elapsed>6000)throw new Error(`Fast path too slow: ${elapsed}ms`);
...
for(const c of d.listings){
  ...
  if(c.price!=null&&(!c.priceVerified||c.priceSource!=='syarah_cash_price_index'))throw new Error(`Unverified fast Syarah price: ${c.price} ${c.url}`);
