...
async function fetchOne(url,meta,timeout){
  try{
    ...
    const image=extractSalehVehicleImage(html,r.url||url,{title});
    return{
      ...
      year,price,mileage:0,city:null,condition:'new',saleVerified:true,
      saleEvidence:['saleh_live_sitemap','saleh_verified_product_page'],
      image:image||null,displayImage:image||null,imageVerified:Boolean(image),
