...
const names={'sa.opensooq.com':'OpenSooq','www.mercedes-benz-mena.com':'Mercedes-Benz Saudi','buy.kayishha.com':'Kayishha','www.mstaml.com':'Mstaml','haraj.com.sa':'Haraj','ksa.carswitch.com':'CarSwitch Saudi','syarah.com':'Syarah','www.salehcars.com':'Saleh Cars','cars.saudisale.com':'Saudi Sale','ksa.motory.com':'Motory','www.samaco.com.sa':'SAMACO Automotive','www.arabwheels.sa':'ArabWheels Saudi'};
...
export function provider(name,{env=process.env,fetchImpl=fetch,metrics=[]}={}){
 const key=(name==='brave'?(env.BRAVE_SEARCH_API_KEY||env.BRAVE_API_KEY):env.TAVILY_API_KEY);if(!key)return null;
