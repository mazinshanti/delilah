...
Live pagination check: the source-provided next-page anchor on Syarah MG ZS led to page 2. Page 1 had 12 direct candidate links; page 2 had 11, all additional unique links (23 total). These 11 additional candidates have not been individually detail-verified or counted as accepted. See `docs/market-pagination-sample-20260919.json`.
