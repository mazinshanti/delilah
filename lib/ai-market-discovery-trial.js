...
export async function runAdaptiveMarketDiscovery(body,intent,{discover=discoverMarketWithAI,readDetail=createMarketDetailReader(),maxRounds=3,maxDetails=24,maxPages=6,concurrency=3,cachedListings=[],previouslyCheckedUrls=[],previouslyReadPages=[],onProgress=()=>{}}={}){
