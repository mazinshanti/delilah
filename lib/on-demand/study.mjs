...
export const allSources=['CarSwitch Saudi','Syarah','Motory','Haraj','ArabWheels Saudi','Saudi Sale','SAMACO Automotive','Saleh Cars'];
...
export function scheduledSources(transport,{webDiscovery=null}={}){
 const base=createSources(transport);
 return {verify:base.verify,discover:async(i,options)=>{
  if(options.signal?.aborted)return;
  const first=prioritySources(i);
