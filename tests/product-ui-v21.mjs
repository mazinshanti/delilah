...
if(health.edge!=='inventory-v21'||health.frontendProgressPolling!==true||health.indexedExactFallback!==true)throw new Error(`v21 product edge not live: ${JSON.stringify(health)}`);
...
console.log('PASS v21 product UI: fast results + progressive background polling wired');
