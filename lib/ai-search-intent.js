...
export function intentSearchBody(incoming,result){
 ...
 const literalFilters=naturalSearch(incoming.query).filters,explicitMileage=literalFilters.maxMileage;
 ...
 for(const k of ['minYear','maxYear','minPrice','maxPrice','city','fuelType'])if(i[k]!=null){
  if(k==='maxPrice'&&explicitMileage!=null&&literalFilters.maxPrice==null)continue;
